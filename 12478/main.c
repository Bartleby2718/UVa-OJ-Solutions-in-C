...
void testEquivalentWhenPermuted(char *string1, char *string2, unsigned length, bool expected)
{
    bool actual = equivalentWhenPermuted(string1, string2, length);
    printf("%s & %s: expected %s, got %s.\n", string1, string2, expected ? "true" : "false", actual ? "true" : "false");
}

int main()
{
    /*
    testEquivalentWhenPermuted("acbb", "cbca", 4, false);
    testEquivalentWhenPermuted("acbc", "bcca", 4, true);
    testEquivalentWhenPermuted("aaaaaaaaaaaaaaaaaaaab", "aaaaaaaaaabaaaaaaaaaa", 21, true);
    return 0;
     */
